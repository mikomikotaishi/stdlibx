...
export namespace stdx::io {
    constexpr auto EOF = _detail::stdx::io::Eof;
    constexpr auto FOPEN_MAX = _detail::stdx::io::FopenMax;
    constexpr auto FILENAME_MAX = _detail::stdx::io::FilenameMax;
    constexpr auto BUFSIZ = _detail::stdx::io::BufSiz;
    constexpr auto _IOFBF = _detail::stdx::io::Iofbf;
    constexpr auto _IOLBF = _detail::stdx::io::Iolbf;
    constexpr auto _IONBF = _detail::stdx::io::Ionbf;
    constexpr auto SEEK_SET = _detail::stdx::io::SeekSet;
    constexpr auto SEEK_CUR = _detail::stdx::io::SeekCur;
    constexpr auto SEEK_END = _detail::stdx::io::SeekEnd;
    constexpr auto TMP_MAX = _detail::stdx::io::TmpMax;
    constexpr auto L_tmpnam = _detail::stdx::io::Ltmpnam;
