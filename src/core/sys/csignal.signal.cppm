/**
 * @internal
 * @file csignal.signal.cppm
 * @module core:sys.csignal.signal
 * @brief Module file for signal handling in the standard library C-style signal operations.
 *
...
export module core:sys.csignal.signal;
