...
int main(int argc, char* argv[]) {
    // Try `--verbose` to see passing tests, `--filter 'TestingFramework.f*'` to select
    ...
    const Suite framework {
        ...
        .tests = {
            {"TestingFramework.basic_assertions", test_basic_assertions},
            {"TestingFramework.floating_point", test_floating_point},
            {"TestingFramework.exceptions", test_exceptions},
            {"TestingFramework.fatal_assertions", test_fatal_assertions},
            {"TestingFramework.skipped", test_skipped},
            {"TestingFramework.hooks_are_per_suite", test_hooks_are_per_suite},
        }
    };
    return run(
        argc,
