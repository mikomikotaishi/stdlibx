...
/**
 * @brief Verifies nano_time() never decreases across many back-to-back samples.
 */
void test_monotonic() {
...
/**
 * @brief Verifies elapsed time over a busy loop is strictly positive.
 */
void test_advances() {
...
/**
 * @brief Verifies steady-clock origin (boot time) yields values vastly smaller
 * than wall-clock nanos since 1970. If nano_time() were still on SystemClock
