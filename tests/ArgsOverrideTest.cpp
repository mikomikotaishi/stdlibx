...
void test_user_arguments_are_one_subspan_away() {
    // The Java/C# shape of the command line - just the user's arguments - is
    // args().subspan(1). With set_args in control the elements are known, so the
    // loop can check what iteration actually sees.
