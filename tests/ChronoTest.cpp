...
void test_iso_chronology() {
    ...
    IsoChronology::Era era = IsoChronology::era_of(-44);
    i32 yoe = IsoChronology::year_of_era(-44);
    System::out.println(
        "year -44 -> era: {}, year-of-era: {}",
        era == IsoChronology::Era::BCE ? "BCE" : "CE",
        yoe
    );
}
...
void test_japanese_chronology() {
    ...
    JapaneseDate showa64 = JapaneseChronology::of(JapaneseChronology::Era::SHOWA, 64, 1, 7);
    ...
    Array<JapaneseEraCase, 3> boundary_cases = {{
        {"Reiwa 1-04-30 (actually last day of Heisei)", JapaneseChronology::Era::REIWA, 1, 4, 30},
        {"Showa 64-01-08 (actually first day of Heisei)", JapaneseChronology::Era::SHOWA, 64, 1, 8},
        {"Showa 65-01-01 (Showa 65 never existed)", JapaneseChronology::Era::SHOWA, 65, 1, 1},
    }};
...
void test_thai_buddhist_chronology() {
    ...
    ThaiBuddhistDate be2500 = ThaiBuddhistChronology::of(2500, 1, 1);
