...
export namespace stdx::core {
    ...
    public:
        ...
        bool is_nan() const noexcept requires HasGet<F, Derived> {
            return std::isnan(static_cast<const Derived&>(*this).get());
        }

        [[nodiscard]]
        bool is_infinite() const noexcept requires HasGet<F, Derived> {
            return std::isinf(static_cast<const Derived&>(*this).get());
        }

        [[nodiscard]]
        bool is_finite() const noexcept requires HasGet<F, Derived> {
            return std::isfinite(static_cast<const Derived&>(*this).get());
        }
    };
    ...
    class [[nodiscard]] SignedByte final: public Number<i8, SignedByte> {
    public:
        [[nodiscard]]
    ...
    class [[nodiscard]] Byte final: public Number<u8, Byte> {
    public:
        [[nodiscard]]
    ...
    class [[nodiscard]] Short final: public Number<i16, Short> {
    public:
        [[nodiscard]]
    ...
    class [[nodiscard]] Integer final: public Number<i32, Integer> {
    public:
        [[nodiscard]]
    ...
    class [[nodiscard]] Long final: public Number<i64, Long> {
    public:
        [[nodiscard]]
    ...
    class [[nodiscard]] UnsignedShort final: public Number<u16, UnsignedShort> {
    public:
        [[nodiscard]]
    ...
    class [[nodiscard]] UnsignedInteger final: public Number<u32, UnsignedInteger> {
    public:
        [[nodiscard]]
    ...
    class [[nodiscard]] UnsignedLong final: public Number<u64, UnsignedLong> {
    public:
        [[nodiscard]]
    ...
    class [[nodiscard]] Character final: public Number<char, Character>, public CharacterBase<char, Character> {
    public:
        using UnicodeBlock = CharacterBase::UnicodeBlock;
        using UnicodeNames = CharacterBase::UnicodeNames;
        using UnicodeScript = CharacterBase::UnicodeScript;
    ...
    class [[nodiscard]] UnsignedCharacter final: public Number<unsigned char, UnsignedCharacter>, public CharacterBase<unsigned char, UnsignedCharacter> {
    public:
        using UnicodeBlock = CharacterBase::UnicodeBlock;
        using UnicodeNames = CharacterBase::UnicodeNames;
        using UnicodeScript = CharacterBase::UnicodeScript;
    ...
    class [[nodiscard]] Character8 final: public Number<char8, Character8>, public CharacterBase<char8, Character8> {
    public:
        using UnicodeBlock = CharacterBase::UnicodeBlock;
        using UnicodeNames = CharacterBase::UnicodeNames;
        using UnicodeScript = CharacterBase::UnicodeScript;
    ...
    class [[nodiscard]] Character16 final: public Number<char16, Character16>, public CharacterBase<char16, Character16> {
    public:
        using UnicodeBlock = CharacterBase::UnicodeBlock;
        using UnicodeNames = CharacterBase::UnicodeNames;
        using UnicodeScript = CharacterBase::UnicodeScript;
    ...
    class [[nodiscard]] Character32 final: public Number<char32, Character32>, public CharacterBase<char32, Character32> {
    public:
        using UnicodeBlock = CharacterBase::UnicodeBlock;
        using UnicodeNames = CharacterBase::UnicodeNames;
        using UnicodeScript = CharacterBase::UnicodeScript;
    ...
    class [[nodiscard]] WideCharacter final: public Number<wchar, WideCharacter>, public CharacterBase<wchar, WideCharacter> {
    public:
        using UnicodeBlock = CharacterBase::UnicodeBlock;
        using UnicodeNames = CharacterBase::UnicodeNames;
        using UnicodeScript = CharacterBase::UnicodeScript;
    ...
    class [[nodiscard]] SignedSize final: public Number<isize, SignedSize> {
    public:
        [[nodiscard]]
    ...
    class [[nodiscard]] UnsignedSize final: public Number<usize, UnsignedSize> {
    public:
        [[nodiscard]]
