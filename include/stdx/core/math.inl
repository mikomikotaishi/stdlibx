...
export namespace stdx::core {
    class Math final {
    public:
        Math() = DELETE_METHOD("Math is a static utility class and cannot be instantiated.");

        static constexpr f64 E = ::stdx::math::numbers::E; ///< e
        static constexpr f64 LOG_2_E = ::stdx::math::numbers::LOG_2_E; ///< log_2 e
        static constexpr f64 LOG_10_E = ::stdx::math::numbers::LOG_10_E; ///< log_10 e
        static constexpr f64 PI = ::stdx::math::numbers::PI; ///< pi
        static constexpr f64 INV_PI = ::stdx::math::numbers::INV_PI; ///< 1/pi
        static constexpr f64 INV_SQRT_PI = ::stdx::math::numbers::INV_SQRT_PI; ///< 1/sqrt(pi)
        static constexpr f64 LN_2 = ::stdx::math::numbers::LN_2; ///< log_e 2
        static constexpr f64 LN_10 = ::stdx::math::numbers::LN_10; ///< log_e 10
        static constexpr f64 SQRT_2 = ::stdx::math::numbers::SQRT_2; ///< sqrt(2)
        static constexpr f64 SQRT_3 = ::stdx::math::numbers::SQRT_3; ///< sqrt(3)
        static constexpr f64 INV_SQRT_3 = ::stdx::math::numbers::INV_SQRT_3; ///< 1/sqrt(3)
        static constexpr f64 E_GAMMA = ::stdx::math::numbers::E_GAMMA; ///< Euler-Mascheroni constant
        static constexpr f64 PHI = ::stdx::math::numbers::PHI; ///< Golden ratio (1+sqrt(5))/2
