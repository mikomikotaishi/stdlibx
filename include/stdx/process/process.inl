...
export namespace stdx::process {
    ...
    public:
        ...
        Expected<Output, ErrorCode> wait_with_output() {
            ...
            if (err_h) {
                err_thread = JoiningThread(drain_handle_to, err_h, &err_data);
            }
            #endif
    ...
    /**
     * @namespace current
     * @brief Namespace for operations on the current process.
     */
    namespace current {
        /**
        ...
        /**
         * @brief Exit the current process with the given code. Does not return.
        ...
        /**
         * @brief Abnormally terminate the current process. Does not return.
         */
        [[noreturn]]
        void abort() noexcept {
            System::abort();
