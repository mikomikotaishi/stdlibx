...
namespace stdx::linq {
     ...
     */
    template <typename Pred, typename Ran>
     ...
     * @tparam Ran The range type.
     */
    template <typename Func, typename Ran>
     ...
     * @tparam Ran The range type.
     */
    template <typename Delim, typename Ran>
    concept Splittable =
    ...
    /**
     * @concept Slideable
     * @brief Concept that checks if Slide can be applied to the range.
     * @tparam Ran The range type.
     */
    template <typename Ran>
    concept Slideable = requires (Ran& r, RangeDifference<Ran> count) {
        { Slide(r, count) };
    };
...
export namespace stdx::linq {
    ...
    public:
         ...
         */
        template <Transformable<Ran> Func>
