...
namespace stdx::time::chrono {
     ...
     */
    [[nodiscard]]
    constexpr bool is_hebrew_leap(i32 y) noexcept {
     ...
     */
    [[nodiscard]]
    constexpr i64 hebrew_elapsed_days(i32 y) noexcept {
    ...
    inline constexpr i64 HEBREW_EPOCH_OFFSET = 2092591; ///< Offset such that epoch_day = hebrew_elapsed_days(y) - HEBREW_EPOCH_OFFSET gives 1 Tishri of year y.
     ...
     */
    [[nodiscard]]
    constexpr i64 hebrew_new_year_epoch_day(i32 y) noexcept {
     ...
     */
    [[nodiscard]]
    constexpr i32 hebrew_year_length(i32 y) noexcept {
     ...
     */
    [[nodiscard]]
    constexpr u32 hebrew_days_in_month(i32 y, u32 m) noexcept {
     ...
     */
    [[nodiscard]]
    constexpr i64 hebrew_to_epoch_day(i32 y, u32 m, u32 d) noexcept {
     ...
     */
    [[nodiscard]]
    constexpr DateComponents epoch_day_to_hebrew(i64 e) noexcept {
