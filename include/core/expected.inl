...
export namespace core {
    ...
    inline constexpr T Ok(Args&&... args) {
        return T(core::util::forward<Args>(args)...);
    }
    ...
    inline constexpr Unexpected<E> Err(Args&&... args) {
        return Unexpected<E>(E(core::util::forward<Args>(args)...));
    }
    ...
    inline constexpr Unexpected<DecayType<E>> Err(E&& err) {
        return Unexpected<core::meta::DecayType<E>>(core::util::forward<E>(err));
    }
    #endif
}
